...
<body>
    ...
    <div class="container">
        ...
        <div class="row contents-margin">
            ...
            <div class="col-xs-8 content-container">
                <div class="text-left">
                    <div class="page-title" id="artista"></div>
                    <div class="page-title-wedge-right"></div><div class="page-title-rectangle"></div>
                </div>
                <table class="table table-hover">
                    ...
                    <tbody id="artista_contents">
                    </tbody>
                </table>
                <div>
                    <ul id="artist-pagination" class="pagination pagination-sm">
                    </ul>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            try {
                createPreviewPlayer();
                var byIdArtist = $.getUrlVar('id');
                var byNameArtist = $.getUrlVar('name');
                carregaNameArtist(byNameArtist);
                carregaArtistList(byIdArtist);
                carregaTop(false);
                carregaCategorias();
                carregaArtistas();
            } catch (ex) {
